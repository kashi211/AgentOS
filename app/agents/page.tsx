...
const TOOL_CATALOGUE: ToolDef[] = [
  ...
  // Files
  { id: "read_file",            label: "Read File",           desc: "Read an existing file from the project output directory",         icon: FileSearch,    color: "#ea580c", group: "Files" },
  { id: "write_file",           label: "Write File",          desc: "Create or overwrite a file in the project output directory",      icon: FileOutput,    color: "#ea580c", group: "Files" },
  { id: "list_files",           label: "List Files",          desc: "List all files written so far for this task",                     icon: List,          color: "#ea580c", group: "Files" },
  { id: "delete_file",          label: "Delete File",         desc: "Remove a file from the project output directory",                 icon: FileX,         color: "#ea580c", group: "Files" },
  { id: "move_file",            label: "Move / Rename File",  desc: "Move or rename a file within the project output directory",       icon: FolderSymlink, color: "#ea580c", group: "Files" },
  // System
...
const CATEGORY_COLORS: Record<string, string> = {
  Engineering: "#0284c7", Research: "#ea580c", Finance: "#059669",
...
function emptyAgent(): Agent {
  return { id: "", role: "", icon: "", color: "#f97316", model: "Claude Sonnet 4.6", description: "", responsibilities: [""], systemPrompt: "", tools: [] };
}
          ...
          {tab === "team" && (
            <div>
              ...
              <div className="card p-4 mb-6 flex gap-6 flex-wrap">
                {[{ model: "Claude Opus 4.7", color: "#f97316", desc: "Heavy reasoning & code" }, { model: "Claude Sonnet 4.6", color: "#059669", desc: "Fast, cost-efficient" }, { model: "Claude Haiku 4.5", color: "#d97706", desc: "Ultra-fast, lightweight" }].map(m => (
                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-3 mb-1 flex-wrap">
                            ...
                            <span className="text-xs px-2 py-0.5 rounded-full font-medium" style={{ background: "var(--accent-light)", color: "var(--accent)", border: "1px solid rgba(249,115,22,0.15)" }}>{agent.model}</span>
                            ...
                            {agent.maxTokens && agent.maxTokens !== 4096 && <span className="text-xs px-2 py-0.5 rounded-full font-mono" style={{ background: "rgba(249,115,22,0.08)", color: "#ea580c", border: "1px solid rgba(249,115,22,0.15)" }}>{agent.maxTokens.toLocaleString()} tok</span>}
