...
const AGENT_COLORS: Record<string, string> = {
  ceo: "#0084c6", planner: "#006ba3", developer: "#0284c7", qa: "#059669",
  writer: "#d97706", researcher: "#006ba3", fact_checker: "#059669",
  devils_advocate: "#dc2626", editor: "#d97706", analyst: "#059669",
  bear_case: "#dc2626", data_agent: "#0284c7", risk_agent: "#d97706",
  synthesizer: "#006ba3", reader: "#78716c", clause_flagger: "#dc2626",
  protection_checker: "#006ba3", legal_editor: "#d97706",
  content_writer: "#ec4899", seo_agent: "#0284c7", brand_voice: "#006ba3",
  content_editor: "#d97706", summarizer: "#006ba3", critic: "#dc2626",
...
const STATUS_CFG: Record<TaskStatus, { label: string; color: string }> = {
  ...
  planning:  { label: "Planning",  color: "#0084c6" },
          ...
          quality ? (
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-3 gap-3">
                {[{label:"Verdict",value:quality.verdict==="pass"?"Pass":"Fail",icon:quality.verdict==="pass"?CheckCircle2:XCircle,color:quality.verdict==="pass"?"#059669":"#dc2626"},{label:"Reviewer",value:quality.reviewer,icon:ShieldCheck,color:"#006ba3"},{label:"Cycles",value:String(quality.revisions),icon:RefreshCw,color:"#0284c7"}].map(({label,value,icon:Icon,color})=>(
    ...
    <div className="flex flex-col min-h-full">
      ...
      {refineOpen && (
        <RefinementModal
          ...
          accentColor={selectedPreset?.categoryColor ?? "#0084c6"}
