    ...
    <div className="px-6 sm:px-10 py-10 max-w-5xl mx-auto">
      ...
      <section className="mb-10">
        ...
        <div className="rounded-xl overflow-hidden" style={{ border: "1px solid var(--card-border)" }}>
          {apiRoutes.map(({ method, path, desc }, i) => {
            const methodColor: Record<string, string> = { POST: "#f97316", GET: "#059669", WS: "#0284c7", PUT: "#d97706", DELETE: "#dc2626" };
      ...
      <section>
        ...
        <div className="rounded-xl p-5" style={{ border: "1px solid var(--card-border)", background: "var(--card)" }}>
          <div className="space-y-3">
            {[
              { step: "1", text: "User selects a preset (built-in or custom), types goal, optionally checks 'Web search', clicks Run.", color: "#f97316" },
              { step: "2", text: "MCQ modal opens: Haiku generates 3 goal-specific questions (never platform/tech). User picks answers or skips.", color: "#ea580c" },
              ...
              { step: "8", text: "QA/reviewer evaluates: pass → advance; fail → loop back (up to max_revisions). User can POST /tasks/{id}/cancel at any time.", color: "#ea580c" },
