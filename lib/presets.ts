...
export const BUILTIN_PRESETS: Preset[] = [
  /* 1 ─ Software Development */
  {
    ...
    agents: [
      {
        id: "ceo", role: "CEO", icon: "👔", color: "#0084c6", model: "Claude Opus 4.7",
      ...
      {
        id: "planner", role: "Planner", icon: "🗺️", color: "#006ba3", model: "Claude Opus 4.7",
  ...
  /* 2 ─ Research & Intelligence */
  {
    ...
    agents: [
      {
        id: "researcher", role: "Researcher", icon: "🔬", color: "#006ba3", model: "Claude Opus 4.7",
  ...
  /* 3 ─ Investment & Business Analysis */
  {
    ...
    agents: [
      ...
      {
        id: "synthesizer", role: "Synthesizer", icon: "🧠", color: "#006ba3", model: "Claude Opus 4.7",
  ...
  /* 4 ─ Legal Document Review */
  {
    ...
    agents: [
      ...
      {
        id: "protection_checker", role: "Protection Checker", icon: "🛡️", color: "#006ba3", model: "Claude Sonnet 4.6",
  ...
  /* 5 ─ Content & Marketing Pipeline */
  {
    ...
    agents: [
      ...
      {
        id: "brand_voice", role: "Brand Voice", icon: "🎯", color: "#006ba3", model: "Claude Sonnet 4.6",
  ...
  /* 6 ─ Academic Literature Review */
  {
    ...
    agents: [
      {
        id: "summarizer", role: "Summarizer", icon: "📚", color: "#006ba3", model: "Claude Opus 4.7",
